...
mongoose.connect("mongodb+srv://syugandharnayak8888:xg3oKIuhdiVxw9wQ@cluster0.cidowqo.mongodb.net/Authenication",
    {
...
app.post("/login", async (req, res) => {
  try {
    ...
    jwt.sign(
      payload,
      "jwtsecured",
      { expiresIn: 36000000 }, //payload is the value of that object like ID
